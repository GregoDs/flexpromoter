...
Widget _iconDetail({
  ...
  bool alignEnd = false,
  bool isPhone = false,
  void Function()? onPhoneTap,
  BuildContext? context,
}) {
  if (isPhone) {
    return _PhoneIconDetail(
      icon: icon,
      label: label,
      value: value,
      alignEnd: alignEnd,
  ...
  // Use GestureDetector for long-press copy
...
// New stateful widget for phone number with loader
class _PhoneIconDetail extends StatefulWidget {
  final IconData icon;
  final String label;
  final String value;
  final bool alignEnd;
  ...
  @override
  State<_PhoneIconDetail> createState() => _PhoneIconDetailState();
}

class _PhoneIconDetailState extends State<_PhoneIconDetail> {
  bool _loading = false;
  ...
  Widget build(BuildContext context) {
    ...
    return Flexible(
      child: Row(
        ...
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Icon(widget.icon, color: Colors.cyan[100], size: 18),
          const SizedBox(width: 6),
          Expanded(
            child: Column(
